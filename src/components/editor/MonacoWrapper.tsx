...
import { EditorService, MonacoService, SpecificationService } from '../../services';
import state from '../../state';

export type MonacoWrapperProps = MonacoEditorProps;

export const MonacoWrapper: React.FunctionComponent<MonacoWrapperProps> = ({ ...props }) => {
  ...
  async function handleEditorDidMount(editor: monacoAPI.editor.IStandaloneCodeEditor) {
  ...
  return editorState.monacoLoaded.get() ? (
    <MonacoEditor
      ...
      theme="artillery-visualizer-theme"
