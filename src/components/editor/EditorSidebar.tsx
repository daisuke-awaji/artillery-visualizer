...
export const EditorSidebar: React.FunctionComponent<EditorSidebarProps> = () => {
  ...
  return (
    <div
      className="flex flex-row items justify-between  border-b border-neutral-700 bg-neutral-800  text-sm"
    ...
    >
      ...
      {/* <div className="flex flex-row items-center" style={{ height: '30px', lineHeight: '30px' }}>
        <div>
          <ul className="flex">
            <li>
              <EditorDropdown />
